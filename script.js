...
function setupBucket() {
  var albumBucketName = 'merkalisvideotrial';//changed
  var bucketRegion = 'ap-south-1';//changed
  var IdentityPoolId = 'ap-south-1:d87f0b35-70cc-4d73-b29d-7e7ce9f076e0';//changed
